...
export const DESK_OBJECTS: Record<DeskObjectId, DeskObjectConfig> = {
  monitor: {
    label: "MONITOR",
    hudLabel: "Terminal",
    cameraTarget: [0, 1.25, -1.0],
    cameraPosition: [0, 0.8, 0.3],
  ...
  notebook: {
    label: "NOTEBOOK",
    hudLabel: "About Me",
    cameraTarget: [-1.25, 0.5, 1.15],
    cameraPosition: [-1.25, 1.2, 1.8],
    position: [-1.65, 0.1, 0.5],
  ...
  papers: {
    label: "PAPERS",
    hudLabel: "Resume",
    cameraTarget: [1.5, 0.5, 0.75],
    cameraPosition: [1.5, 1.2, 1.4],
  ...
  phone: {
    label: "PHONE",
    hudLabel: "Socials",
    cameraTarget: [-0.95, 0.1, 0.35],
    cameraPosition: [-1, 0.9, 1.0],
    position: [-0.95, 0.1, 0.35],
