...
export function WeatherIcon({ condition, timeOfDay }: { condition: Condition; timeOfDay: TimeOfDay }) {
  switch (condition) {
    case "clear":
      if (timeOfDay === "day") return <SunIcon />;
      if (timeOfDay === "afternoon") return <SunsetIcon />;
      return <MoonIcon />;
    case "clouds":
      return <CloudIcon />;
    case "rain":
...
export function useWeather() {
  const [weather, setWeather] = useState<{ condition: Condition; timeOfDay: TimeOfDay } | null>(null);
